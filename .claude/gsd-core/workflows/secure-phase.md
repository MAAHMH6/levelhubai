...
```
Agent(
  prompt="Read C:/Users/acer/Downloads/LevelHub/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/templates/SECURITY.md`
