...
ones). Reference: @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/Users/acer/Downloads/LevelHub/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/Users/acer/Downloads/LevelHub/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/templates/spec.md.
