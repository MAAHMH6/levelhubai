...
INSTALL_JS_GLOBAL="C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
