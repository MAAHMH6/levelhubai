...
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/project-skills-discovery.md
- Load `rules/*.md` as needed during **planning**.
- Ensure plans account for project skill patterns and conventions.

**agent_skills:** self-load per @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/agent-skills-bootstrap.md
</project_context>
...
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
Full rules: @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/context-budget.md (Phase Sizing). Read before sizing.
...
<execution_context>
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/workflows/execute-plan.md
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/templates/summary.md
</execution_context>
...
See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-antipatterns.md
...
@C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/thinking-models-planning.md
...
See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-guidance.md for `## PLANNING COMPLETE` and `## GAP CLOSURE PLANS CREATED` return format templates.

See @C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
