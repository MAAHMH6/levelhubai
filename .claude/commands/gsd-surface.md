...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/acer/Downloads/LevelHub/.claude/.gsd-surface.json`
(sibling to `C:/Users/acer/Downloads/LevelHub/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/acer/Downloads/LevelHub/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/acer/Downloads/LevelHub/.claude/skills`).
...
`C:/Users/acer/Downloads/LevelHub/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/acer/Downloads/LevelHub/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/acer/Downloads/LevelHub/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/acer/Downloads/LevelHub/.claude/.gsd-profile`
Skill dirs: `C:/Users/acer/Downloads/LevelHub/.claude/skills/gsd-*/`
Engine module: `C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/acer/Downloads/LevelHub/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
