-- ==============================================================================
-- PHASE 2A: Cambridge O Level Canonical Subjects Reconciliation
...
-- 1. In-place UPDATE of existing O Level subjects to ensure canonical names, codes, colors, orders, and icons
...
-- 2. Insert missing canonical O Level subject containers (idempotent ON CONFLICT DO UPDATE)
